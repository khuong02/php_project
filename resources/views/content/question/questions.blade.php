                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $.each(res.questions, function(key, value) {
                            appenddata+='<tr>';
                            appenddata+='<td><a href=""><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'+value.question+'</strong></a></td>';
                            appenddata+='<td><i class="fab fa-angular fa-lg text-danger me-3"></i> '+value.topic+'</td>';
                            appenddata+='<td><i class="fab fa-angular fa-lg text-danger me-3"></i> '+value.difficult+'</td>';
                        ...
                        $.each(res.topics,function(key,value){
                            optiontopic+='<option value='+value.id+'>'+value.name+'</option>';
                        });

                        //Chèn dữ liệu difficult vào select difficult
                        var optiondiff = '';
                        $.each(res.difficults,function(key,value){
                            optiondiff+='<option value='+value.id+'>'+value.name+'</option>';
                        });
